...
namespace Native.App.Export
{
	...
	{	
		...
		{	
			return "9,cn.mikualpha.orderlimit";	
		}	
		...
		{	
			...
			AppData.UnityContainer.RegisterInstance<CQLog> ("cn.mikualpha.orderlimit", AppData.CQLog);	
		...
		{	
			...
			{	
				CQPrivateMessageEventArgs args = new CQPrivateMessageEventArgs (AppData.CQApi, AppData.CQLog, 1, 21, "私聊消息处理", "_eventPrivateMsg", 20000, subType, msgId, fromQQ, msg.ToString(CQApi.DefaultEncoding), false);	
		...
		{	
			...
			{	
				CQGroupMessageEventArgs args = new CQGroupMessageEventArgs (AppData.CQApi, AppData.CQLog, 2, 2, "群消息处理", "_eventGroupMsg", 20000, subType, msgId, fromGroup, fromQQ, fromAnonymous, msg.ToString(CQApi.DefaultEncoding), false);	
